...
void main() {
  ...
  test('Test encode & decode', () {
    ...
    expect(b64data.length, 88);
    expect(b64data, "OTRlYTQ1YzMyYzI5MDllNTQwNzBhZDNmMmNlMjg2Zjk4YjU2ZWY1YzcyOGY1NmQ3ZDNhMDljNWJiNTU5MzA1Nw==");
  ...
  test('Test split & merge', () {
    ...
    expect(sss.inNumbers(arr, BigInt.parse("49937119214509114343548691117920141602615245118674498473442528546336026425464")), true);
    var rs = sss.mergeBigIntToString(arr);
    expect(rs, s);
  });

  test('Test create & combine', () {
    String s = "nghiatcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
